                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    Manage history and view all animals.
                                </p>
                            </div>
                                ...
                                @forelse ($this->animals() as $animal_key => $animal)
                                    <tr wire:key="animal-{{ $animal_key }}">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <img src="{{ asset('storage/' . $animal->image) }}"
                                                    alt="{{ $animal->name }}" class="w-25 h-10 object-cover rounded-md">
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-3">
                                                <span
                                                    class="text-sm text-gray-500 dark:text-neutral-500">{{ $animal->deleted_at->diffForHumans() }}</span>
                                            </div>
                                        </td>
                                        <td class="size-px whitespace-nowrap">
