  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
      <div class="hidden md:block mb-24 md:mb-0 sm:px-6">
        <div class="relative">
          <img class="rounded-xl" src="https://i.pinimg.com/736x/33/e4/f8/33e4f89fa2ba21094660499f93fe689e.jpg"
            alt="Avatar">

          <!-- SVG Element -->
          <div class="absolute bottom-0 start-0 -z-1 translate-y-10 -translate-x-14">
            <svg class="max-w-40 h-auto text-muted-foreground" width="696" height="653" viewBox="0 0 696 653"
      ...
      <div>
        ...
        <blockquote class="relative">
          <svg class="absolute top-0 start-0 transform -translate-x-8 -translate-y-4 size-24 text-foreground/20"
          ...
          <div class="relative z-10">
            <h1 class="text-xl font-medium italic text-foreground md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
              About Us
            </h1>

            <p
              class="text-xl font-medium italic text-foreground md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
              Welcome to the Manila Zoo, a historic wildlife park in Manila dedicated to conservation, education, and
              recreation.

              We provide a safe home for diverse animal species while promoting awareness of environmental protection.
              Our goal is to inspire visitors to appreciate wildlife and support efforts to preserve nature for future
            </p>
          </div>
          ...
          <footer class="mt-6">
            <div class="flex items-center">
              ...
              <div class="ms-4 md:ms-0">
                <div class="text-base font-semibold text-foreground">Bsis3B Zoo</div>
                <div class="text-xs text-muted-foreground-1">Zoologist & Wildlife Conservationist</div>
              </div>
            </div>
          </footer>
